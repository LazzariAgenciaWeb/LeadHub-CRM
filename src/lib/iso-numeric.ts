/**
 * Mapping ISO 3166-1 numeric → alpha-2.
 * Usado pra converter os IDs do world-atlas topojson (numéricos) pros
 * códigos alpha-2 que GA4 nos entrega (BR, US, etc.).
 *
 * Lista resumida — cobre os ~120 países com tráfego significativo. Países não
 * mapeados retornam null e são ignorados visualmente no mapa.
 */
...
export const ISO_NUMERIC_TO_ALPHA2: Record<string, string> = {
  ...
  "570": "NU", "574": "NF", "578": "NO", "580": "MP", "581": "UM",
...
/** Converte ID numérico (ou número) → alpha-2. Retorna null se desconhecido. */
export function toAlpha2(numericId: string | number): string | null {
