...
export const BADGE_META: Record<BadgeType, BadgeMeta> = {
  ...
  CLOSER:          { emoji: "💰", name: "Vendas",          description: "Oportunidades convertidas em venda (oportunidade gera venda; lead apenas gera reunião)" },
...
export const REASON_LABEL: Record<ScoreReason, { text: string; positive: boolean }> = {
  ...
  LEAD_CONVERTIDO:        { text: "Oportunidade convertida em venda", positive: true  },
